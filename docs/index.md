# go-ruby-capistrano documentation

**Pure-Go Capistrano core (deploy DSL + injectable command runner), CGO=0 — bound into rbgo**

`go-ruby-capistrano/capistrano` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `capistrano`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-capistrano/capistrano`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `capistrano`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`capistrano`](https://github.com/go-ruby-capistrano/capistrano) | the library — Ruby's `capistrano` in pure Go |
| [`docs`](https://github.com/go-ruby-capistrano/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-capistrano.github.io`](https://github.com/go-ruby-capistrano/go-ruby-capistrano.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-capistrano/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-capistrano/capistrano](https://github.com/go-ruby-capistrano/capistrano).
