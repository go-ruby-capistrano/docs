...
The public API lives at the module root (`github.com/go-ruby-capistrano/capistrano`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `capistrano`, while the surface follows
...
```go
import "github.com/go-ruby-capistrano/capistrano"
```
...
- **[pkg.go.dev/github.com/go-ruby-capistrano/capistrano](https://pkg.go.dev/github.com/go-ruby-capistrano/capistrano)**

The module's [README](https://github.com/go-ruby-capistrano/capistrano#readme) carries worked
