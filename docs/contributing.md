...
Contributions are welcome. `go-ruby-capistrano/capistrano` is built to a small set of
...
The library is in [`github.com/go-ruby-capistrano/capistrano`](https://github.com/go-ruby-capistrano/capistrano).
This documentation site is in [`github.com/go-ruby-capistrano/docs`](https://github.com/go-ruby-capistrano/docs).
